...
TextFile::TextFile(std::vector<Flux::string> conts)
{
	lines = conts;
	Contents = conts;
}
 ...
 */
FileIOErrors TextFile::GetLastError()
{
	return lasterror;
}
/** File Name
 ...
 * \return filename
 */
Flux::string TextFile::GetFilename()
{
	return filename;
}
/** Edit File Lines
 ...
 */
void TextFile::Edit(int ln, Flux::string fs)
{
	lines[ln] = fs;
	Contents[ln] = fs;
}
 ...
 */
Flux::string TextFile::SingleLine()
{
	return SingleLineBuffer;
}
/** File Extension
