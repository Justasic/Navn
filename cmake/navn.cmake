    ...
    if(QUOTE_TYPE STREQUAL "angle brackets")
      ...
      if(CHECK_ANGLE_INCLUDES)
        ...
        if(FOUND_${FILENAME}_INCLUDE)
          ...
          set(${SKIP} TRUE)
          message("${SRC} needs header file ${FILENAME} but that header file was not found! Check that the header file is within the search path of your OS.")
  ...
  foreach(REQUIRED_LIBRARY ${REQUIRED_LIBRARIES})
    ...
    foreach(LIBRARY ${REQUIRED_LIBRARY})
      ...
      if(FOUND_${LIBRARY}_LIBRARY)
        ...
        message("${SRC} needs library ${LIBRARY} but that library was not found! Check that the library is within the search path of your OS.")
