 ...
 * \fn void rdns(Socket &sock, irc_string *reply, Flux::string dest, Flux::string argv)
 * \fn void dns(Socket &sock, Flux::string dest, Flux::string host)
 * \fn void dns_m(Socket &sock, irc_string *reply, Flux::string rply)
...
*/
void rdns(Socket &sock, irc_string *reply, Flux::string dest, Flux::string argv) {
    nerp.str("");/* Sanity check so we dont segfault */
    struct in_addr ip;
    int res;
...
*/
void dns(Socket &sock, Flux::string dest, Flux::string host){
  struct hostent *he;
...
void dns_m(Socket &sock, irc_string *reply, Flux::string rply){  
  if(reply->said("!rdns")){
