...
public:
	...
	inline Flux::string GetAuthor()
	{
		return this->author;
	}
	inline Flux::string GetVersion()
	{
		return this->version;
	}
	...
	inline ModulePriority GetPriority()
	{
		return this->Priority;
	}
	inline time_t GetLoadTime()
	{
	...
	virtual ~Module();
	virtual EventResult OnPreReceiveMessage(const Flux::string &)
	{
