...
namespace Flux
{
	...
	public:
		...
		string() : _string("") { }
		explicit string(float f) : _string()
		{
			_string = value_cast<sstr>(f);
		}
		explicit string(double d) : _string()
		{
			_string = value_cast<sstr>(d);
		}
		explicit string(int i) : _string()
		{
			_string = value_cast<sstr>(i);
		}
		string(char chr) : _string()
		{
			_string = chr;
		}
		string(const Flux::vector &params) : _string()
		{
			_string = value_cast<sstr>(ConcatinateVector(params));
		}
		...
		inline string &operator=(const Flux::vector &params)
		{
			this->_string = value_cast<sstr>(ConcatinateVector(params));
			return *this;
		}
		...
		inline string &operator=(const sstr &_str)
		{
			this->_string = _str;
			return *this;
		}
		inline string &operator=(const ci::string &_str)
		{
			this->_string = _str.c_str();
			return *this;
		}
		inline string &operator=(const string &_str)
		{
			if(this != &_str) this->_string = _str._string;
		...
		inline bool operator==(const sstr &_str) const
		{
			return this->_string == _str;
		}
		...
		inline bool equals_cs(const sstr &_str) const
		{
			return this->_string == _str;
		}
		inline bool equals_cs(const ci::string &_str) const
		{
			return this->_string == _str.c_str();
		}
		...
		inline bool equals_ci(const sstr &_str) const
		{
			return ci::string(this->_string.c_str()) == _str.c_str();
		}
		inline bool equals_ci(const ci::string &_str) const
		{
			return _str == this->_string.c_str();
		}
		...
		inline const string operator+(const Flux::vector &params) const
		{
			return string(*this) += ConcatinateVector(params);
		}
		inline const string operator+(const char *_str) const
		{
			return string(*this) += _str;
		}
		inline const string operator+(const sstr &_str) const
		{
			return string(*this) += _str;
		}
		inline const string operator+(const ci::string &_str) const
		{
			return string(*this) += _str;
		}
		...
		inline const sstr &std_str() const
		{
			return this->_string;
		}
		inline sstr &std_str()
		...
		{
			return this->_string.max_size();
		}
		inline void swap(string &_str)
		{
			this->_string.swap(_str._string);
		}
		inline void push_back(char c)
		{
			return this->_string.push_back(c);
		}
		inline void push_back(const string &_str)
		{
			if(this != &_str) this->_string += _str._string;
		}
		...
		inline string erase(size_t pos = 0, size_t n = sstr::npos)
		{
			return this->_string.erase(pos, n);
		}
		...
		inline bool search(const string &_str)
		{
			if(_string.find(_str._string) != sstr::npos) return true;

			return false;
		}
		inline bool search(const string &_str) const
		{
			if(_string.find(_str._string) != sstr::npos) return true;

			return false;
		}
		inline bool search_ci(const string &_str)
		{
			if(ci::string(this->_string.c_str()).find(ci::string(_str.c_str())) != ci::string::npos) return true;

			return false;
		}
		inline bool search_ci(const string &_str) const
		{
			if(ci::string(this->_string.c_str()).find(ci::string(_str.c_str())) != ci::string::npos) return true;
		...
		{
			return ci::string(this->_string.c_str()).find(ci::string(_str._string.c_str()), pos);
		}
		...
		{
			return ci::string(this->_string.c_str()).rfind(ci::string(_str._string.c_str()), pos);
		}
		...
		{
			return ci::string(this->_string.c_str()).find_first_of(ci::string(_str._string.c_str()), pos);
		}

		inline size_type find_first_not_of(const string &_str, size_type pos = 0) const
		{
			return this->_string.find_first_not_of(_str._string, pos);
		}
		inline size_type find_first_not_of_ci(const string &_str, size_type pos = 0) const
		{
			return ci::string(this->_string.c_str()).find_first_not_of(ci::string(_str._string.c_str()), pos);
		}
		...
		inline size_type find_last_of_ci(const string &_str, size_type pos = npos) const
		{
			return ci::string(this->_string.c_str()).find_last_of(ci::string(_str._string.c_str()), pos);
		}

		inline size_type find_last_not_of(const string &_str, size_type pos = npos) const
		{
			return this->_string.find_last_not_of(_str._string, pos);
		}
		inline size_type find_last_not_of_ci(const string &_str, size_type pos = npos) const
		{
			return ci::string(this->_string.c_str()).find_last_not_of(ci::string(_str._string.c_str()), pos);
		}
		...
		inline string replace(size_type pos, size_type n, const string &_str, size_type pos1, size_type n1)
		{
		...
		inline string append(const string &_str)
		{
			return this->_string.append(_str._string);
		}
		inline string append(const string &_str, size_t pos, size_t n)
		{
			return this->_string.append(_str._string, pos, n);
		}
		inline string append(const char *s, size_t n)
		{
			return this->_string.append(s, n);
		}
		inline string append(const char *s)
		{
			return this->_string.append(s);
		}
		inline string append(size_t n, char c)
		{
			return this->_string.append(n, c);
		}

		inline int compare(const string &_str) const
		{
			return this->_string.compare(_str._string);
		}
		inline int compare(const char *s) const
		{
			return this->_string.compare(s);
		}
		inline int compare(size_t pos1, size_t n1, const string &_str) const
		{
			return this->_string.compare(pos1, n1, _str._string);
		}
		inline int compare(size_t pos1, size_t n1, const char *s) const
		{
			return this->_string.compare(pos1, n1, s);
		}
		inline int compare(size_t pos1, size_t n1, const string &_str, size_t pos2, size_t n2) const
		{
			return this->_string.compare(pos1, n1, _str._string, pos2, n2);
		}
		inline int compare(size_t pos1, size_t n1, const char *s, size_t n2) const
		{
			return this->_string.compare(pos1, n1, s, n2);
		}

		inline string insert(size_t pos1, const string &_str)
		{
			return this->_string.insert(pos1, _str._string);
		}
		inline string insert(size_t pos1, const string &_str, size_t pos2, size_t n)
		{
			return this->_string.insert(pos1, _str._string, pos2, n);
		}
		inline string insert(size_t pos1, const char *s, size_t n)
		{
			return this->_string.insert(pos1, s, n);
		}
		inline string insert(size_t pos1, const char *s)
		{
			return this->_string.insert(pos1, s);
		}
		inline string insert(size_t pos1, size_t n, char c)
		{
			return this->_string.insert(pos1, n, c);
		}
		inline iterator insert(iterator p, char c)
		{
			return this->_string.insert(p, c);
		}
		...
		{
			return this->_string.insert(p, first, last);
		}

		inline string assign(const string &str)
		{
			return this->_string.assign(str._string);
		}
		inline string assign(const Flux::vector &params)
		{
			return this->_string.assign(value_cast<sstr>(ConcatinateVector(params)));
		}
		inline string assign(const string &str, size_t pos, size_t n)
		{
			return this->_string.assign(str._string, pos, n);
		}
		inline string assign(const char *s, size_t n)
		{
			return this->_string.assign(s, n);
		}
		inline string assign(const char *s)
		{
			return this->_string.assign(s);
		}
		inline string assign(size_t n, char c)
		{
			return this->_string.assign(n, c);
		}
		template <class InputIterator> inline string assign(InputIterator first, InputIterator last)
		{
			return this->_string.assign(first, last);
		}
		...
		template <class InputIterator> inline string replace(iterator first, iterator last, InputIterator f, InputIterator l)
		{
		...
		{
			return this->_string.get_allocator();
		}
		...
		inline operator int()
		{
			return value_cast<int>(this->_string);
		}
		/* Cast into a float */
		inline operator float()
		{
			return value_cast<float>(this->_string);
		}
		/* Cast into a double */
		inline operator double()
		{
			return value_cast<double>(this->_string);
		}
		/* Cast into a long integer */
		inline operator long()
		{
			return value_cast<long>(this->_string);
		}
		/* Cast into a unsigned integer */
		inline operator unsigned()
		{
			return value_cast<unsigned>(this->_string);
		}
	...
	inline std::istream &operator>>(std::istream &os, string &_str)
	{
		return os >> _str._string;
	}
...
//   inline const string operator+(const Flux::vector &params) { string tmp; temp += ConcatinateVector(params); return tmp; }
	...
	inline const string operator+(const sstr &_str, const string &str)
	{
		string tmp(_str);
		tmp += str;
		return tmp;
	}
	inline const string operator+(const ci::string &_str, const string &str)
	{
		string tmp(_str);
		tmp += str;
		return tmp;
